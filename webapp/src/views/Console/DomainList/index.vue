  ...
  <v-card>
    <v-card-title>
      ...
      <v-btn
        color="primary"
        depressed
        @click.native="showNewDomainDialog = true"
      >
        Create new domain
      </v-btn>
    </v-card-title>
          ...
          <td>
            ...
            >
              <v-btn
                ...
                flat
                icon
                @click.stop="openDomainDetailsDialog(props.item.name)"
              >
              ...
              <v-btn
                ...
                flat
                icon
                @click.stop="openDomainDeletionDialog(props.item.name)"
              >
      ...
      <template slot="no-data">
        ...
        >
          ...
          <v-btn
            color="primary"
            depressed
            @click.stop="showNewDomainDialog = true"
          >
            Create new domain
          </v-btn>
        </div>
